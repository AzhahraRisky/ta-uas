...
class Konsumen_model extends CI_Model
{
	...
	private function _uploadImage()
	{
		...
		return base_url('upload/bukti/') . $post["gambar_lama"];
	}
	...
	public function delete($id)
	{
		...
		return $this->db->delete($this->_table, array('kd_konsumen' => $id));
	}
	...
	private function _deleteImage($id)
	{
		...
		if ($konsumen->foto != "default.jpg") {

			$filename = explode(".", $konsumen->foto)[0];

			return array_map('unlink', glob(FCPATH . "/assets/img/profil/$filename.*"));
		}
	}
}
