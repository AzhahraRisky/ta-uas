<nav class="sb-topnav navbar navbar-expand navbar-dark bg-secondary shadow">

    <button class="btn btn-link btn-lg order-1 order-lg-0 text-white ml-2" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button>

    <a class="navbar-brand pl-1" href="<?php echo site_url('admin/produk') ?>">Matsuri Castle </a>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="<?php echo site_url('home') ?>">Beranda</a>
