...
class Order extends CI_Controller
{
    ...
    public function printNota($no_nota)
    {
        ...
        $pdf->AddPage();
        $image = "assets/img/logo/matsurilogo 67x47.png";
        $pdf->SetFont('Arial', 'B', 16);
        $pdf->Cell(40, 40, $pdf->Image($image, $pdf->GetX(), $pdf->GetY(), 33.78), 0, 0, 'L', false);
        $pdf->Cell(0, 4, '', 0, 1, 'C');
        $pdf->Cell(0, 7, 'Nota Pembelian', 0, 1, 'C');
        $pdf->SetFont('Arial', 'B', 8);
        $pdf->Cell(0, 4, 'Jl. Arteri Soekarno-Hatta No.123', 0, 1, 'C');
        $pdf->Cell(0, 4, 'HP: +62 857-4222-3710, EMAIL: matsuricastle@gmail.com', 0, 1, 'C');
        $pdf->Cell(10, 7, '', 0, 1);
